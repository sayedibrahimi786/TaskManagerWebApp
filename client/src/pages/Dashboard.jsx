...
const Dashboard = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      total: totals.filter((task) => task.stage === "completed").length || 0,
    ...
    },
    {
      ...
      total: totals.filter((task) => task.stage === "inprogress").length || 0,
    ...
    },
    {
      _id: "4",
      label: "TO DO TASK",
      total: totals.filter((task) => task.stage === "todo").length || 0,
      icon: <FaArrowsToDot />,
      bg: "bg-[#be185d]" || 0,
    },
  ];
  ...
  return (
    <div className="h-full py-4">
      ...
      <div className="w-full flex flex-col md:flex-row gap-4 2xl:gap-10 py-8">
        {/* RECENT AUTHORS */}
        {dashboardTasks && <TaskTable tasks={dashboardTasks} />}
        {/* RECENT USERS */}
        {/* {dashboardTasks && userInfo?.isAdmin && (
          <UserTable userInfo={dashboardTasks?.userInfo} />
        )} */}
      </div>
    </div>
  );
